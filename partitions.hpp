...
public:
	...
	bool Resize_Super_Volume(TWPartition* twrpPart, unsigned long long image_size); // Resize logical super partition volume for flashing
	...
	void UnMount_System_Partitions(void);                                     // Unmount all logical or main partitions
