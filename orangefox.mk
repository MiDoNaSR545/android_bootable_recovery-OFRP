...
ifeq ($(FOX_VANILLA_BUILD),1)
    ...
    OF_DISABLE_INCREMENTAL_OTA_FEATURES := 1
...
ifeq ($(OF_DISABLE_INCREMENTAL_OTA_FEATURES),1)
    LOCAL_CFLAGS += -DOF_DISABLE_INCREMENTAL_OTA_FEATURES='"1"'
    OF_TWRP_COMPATIBILITY_MODE := 1
endif

ifeq ($(OF_DISABLE_INCREMENTAL_OTA_BY_DEFAULT),1)
    LOCAL_CFLAGS += -DOF_DISABLE_INCREMENTAL_OTA_BY_DEFAULT='"1"'
endif
...
ifeq ($(OF_NO_INCREMENTAL_OTA_VENDOR_BACKUP),1)
    LOCAL_CFLAGS += -DOF_NO_INCREMENTAL_OTA_VENDOR_BACKUP='"1"'
endif
...
ifeq ($(OF_SUPPORT_ALL_BLOCK_OTA_UPDATES),1)
   ifeq ($(OF_DISABLE_INCREMENTAL_OTA_FEATURES),1)
        $(warning You cannot use "OF_SUPPORT_ALL_BLOCK_OTA_UPDATES" with "OF_DISABLE_INCREMENTAL_OTA_FEATURES"/"OF_TWRP_COMPATIBILITY_MODE")
...
ifeq ($(OF_DISABLE_OTA_MENU),1)
    ...
    OF_DISABLE_INCREMENTAL_OTA_FEATURES := 1
    OF_DISABLE_INCREMENTAL_OTA_BY_DEFAULT := 1
    OF_NO_MIUI_PATCH_WARNING := 1
    OF_DONT_PATCH_ENCRYPTED_DEVICE := 1
    OF_KEEP_DM_VERITY_FORCED_ENCRYPTION := 1
endif
